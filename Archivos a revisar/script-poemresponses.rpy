...
label ch1_y_end:
    call showpoem (poem_y1, img="yuri 3t") from _call_showpoem_5
    y 3t "..."
    y "¡L.. lo siento por tener tan mala letra!"
    mc "¿Qué?"
    mc "No estaba pensando en eso..."
    y 2v "Pero te ha tomado un tiempo leerlo todo..."
    mc "Ah..."
    mc "Bueno, es que no suelo leer en cursiva con tanta frecuencia."
    mc "En realidad, pienso que tu letra es bastante bonita."
    y 2t "¿Eh?"
    y 2u "Es... es un alivio..."
    mc "Además, me ha encantado el poema."
    mc "Aunque es corto, era bastante descriptivo."
    y 2t "¿No ha sido 'demasiado' corto?"
    y "Normalmente escribo poemas más largos..."
    mc "No del todo."
    ...
    y 1m "Ujujuju."
    y "En realidad, la historia no va del todo sobre un fantasma, [player]."
    mc "¿En serio?"
    mc "Debo haber perdido completamente el hilo..."
    y 1u "Bueno, supongo que le echaste un vistazo rápido, después de todo..."
    y "Pero recuerda que los poetas suelen expresar sus propios pensamientos, sentimientos y experiencias en su obra."
    y 1a "Normalmente hacen más que contar una simple historia, o pintar un cuadro."
    y "En este caso, quizá el sujeto del poema sea comparado simbólicamente con un fantasma."
    y 2l "Aferrándose a su último lugar de confort, incapaz de dejar el pasado atrás."
    y "Y pronto se quedará sin nada..."
    mc "... Es mucho más serio, dicho de esa manera."
    mc "Ni lo había pensado de esa manera..."
    mc "Es impresionante."
    if poemopinion == "good":
        y 2f "¿Eh?"
        y 3v "¡N-no es nada, en serio!"
        y "El tuyo fue impresionante también, así que..."
        mc "Nah..."
        mc "Si acaso, probablemente podría aprender un par de cosas de ti."
        y 4a "... ¿Eso crees?"
        mc "Claro, por supuesto."
        y "Ah..."
        y 2s "¿Sabes...?"
        y "Estaba muy nerviosa haciendo todo esto..."
        y "Pero al final, lo he disfrutado."
        y "Voy a seguir esforzándome al máximo por ti, [player]."
        mc "Ah..."
        mc "Yo también."
    else:
        y 1u "No es nada, en serio..."
        y "Bueno... me hace feliz que pienses eso."
        y 1a "Solo recuerda que no pasará mucho tiempo antes de que también te des cuenta de estas cosas."
        mc "Sí, puede que tengas razón."
        mc "Supongo que tendré que seguir intentándolo."
        y "Cuento contigo."
    return

label ch2_y_end:
    call showpoem (poem_y2) from _call_showpoem_6
    y 2m "Um..."
...
label ch3_y_end:
    ...
    call showpoem (poem_y3, img="yuri 2v") from _call_showpoem_7
    y "Um..."
...
label ch3_y_end_special:
    call showpoem (poem_y3b, img="yuri 4b") from _call_showpoem_8
...
label ch1_n_end:
    call showpoem (poem_n1, img="natsuki 2s") from _call_showpoem_9
    n 2q "Yeah..."
...
label ch2_n_end:
    call showpoem (poem_n2) from _call_showpoem_10
    n 2a "Not bad, right?"
...
label ch3_n_end:
    ...
    call showpoem (poem_n3) from _call_showpoem_11
    n 2a "Yeah..."
...
label ch3_n_end_special:
    call showpoem (poem_n3b) from _call_showpoem_12
    n 1q "..."
...
label ch1_s_end:
    call showpoem (poem_s1) from _call_showpoem_13
    mc "Sayori..."
...
label ch2_s_end:
    call showpoem (poem_s2) from _call_showpoem_14
    mc "Holy crap..."
...
label ch1_m_end:
    call showpoem (poem_m1) from _call_showpoem_15
...
label ch2_m_end:
    call showpoem (poem_m2) from _call_showpoem_16
    mc "Hm..."
...
label ch3_m_end:
    call showpoem (poem_m3) from _call_showpoem_17
    m 1a "You know..."
