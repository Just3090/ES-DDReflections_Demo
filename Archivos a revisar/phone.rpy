...
define 5 phone.enter_transition = Dissolve(0.6, time_warp=_warper.ease)
define 5 phone.exit_transition = Dissolve(0.6, time_warp=_warper.ease)

define 5 phone.character_short_name_length = 16

define 5 phone.group_chat_short_name_length = 9
define 5 phone.group_chat_messages_displayed = 175
define 5 phone.group_chat_messages_fill_if_lower = 15

define 5 phone.message_delay = 0.6
define 5 phone.message_time_pattern = _("{hour}:{minute}")
define 5 phone.message_date_pattern = _("{month}/{day}/{year}")


default 5 phone.sayori = phone.Character("Sayori", "mod_assets/phone/sayori_icon.png", "s", 21, "#22Abf8")
default 5 phone.mc = phone.Character("MC", "mod_assets/phone/mc_icon.png", "mc", 35, "#484848")
default 5 phone.natsuki = phone.Character("Natsuki", "mod_assets/phone/natsuki_icon.png", "n", 45, "#fbb")
default 5 phone.monika = phone.Character("Monika", "mod_assets/phone/monika_icon.png", "m", 40, "#0a0")
default 5 phone.yuri = phone.Character("Yuri", "mod_assets/phone/yuri_icon.png", "y", 20, "#a327d6")

default 5 pov_key = "mc"

define 5 phone_s = Character(kind=s, screen="phone_say", who_style="phone_say_label", what_style="phone_say_dialogue")
define 5 phone_mc = Character(kind=mc, screen="phone_say", who_style="phone_say_label", what_style="phone_say_dialogue")
define 5 phone_m = Character(kind=m, screen="phone_say", who_style="phone_say_label", what_style="phone_say_dialogue")
define 5 phone_n = Character(kind=n, screen="phone_say", who_style="phone_say_label", what_style="phone_say_dialogue")
define 5 phone_y = Character(kind=y, screen="phone_say", who_style="phone_say_label", what_style="phone_say_dialogue")

define 5 _phone_narrator = Character(kind=narrator, screen="phone_say", what_style="phone_say_dialogue")
define 5 _backup_narrator = narrator
        ...
        if phone._currently_typing is not None and phone._currently_typing.is_pov and phone._currently_typing._current_message is not None:
            fixed:
                ...
                viewport at phone._AutoScrollVP:
                    ...
                    has frame style "phone_textbox_typing_text_frame"
...
default mc_monika = phone.GroupChat("Monika", "mod_assets/phone/monika_icon.png", "mc_monika")
...
init -1 python in phone:
    ...
    @register
    def __register_mc_monika__messages():
        register_group_chat(store.mc_monika, "mc", "m")
        register_date("mc_monika", 4, 21, 2023, 19, 30)
        register_message("mc_monika", "m", _("Heyyy! It's me Monika. What are u doing rn?"))
