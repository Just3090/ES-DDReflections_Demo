label ch2_main:
    ...
    mc "Fucking alarm..."
    stop music
    "I hit the alarm to stop it."
    mc "{i}-sigh-{/i} Here we go... {w=0.58} a new day begins."
    "I get out of bed and have a good stretch."
    "I take a look around my room at the same time."
    mc "...Gnnnnnn... where is my uniform again...?"
    mc "..."
    mc "Ah! There it is."
    "I grab my uniform and put it on."
    "After grabbing my bag, I head to the bathroom, brushing my hair quickly."
    "I adjust my tie and then walk out of the bathroom."
    play sound closet_close
    show bg kitchen
    with wiperight_scene
    "I glance at my phone."
    "{i}6:40 AM{/i}"
    "I have enough time to eat breakfast."
    "I head into the kitchen, pulling out a bowl of cereal and a carton of milk, before serving myself a good proportion of cereal."
    "While I'm eating my breakfast, I keep myself busy by reading a book for most of the morning."
    show bg kitchen
    with wipeleft_scene
    mc "I think that's enough."
    "I gently close the page of the book and put it back in my bag."
    "I pull out my phone looking at the time."
    "{i}7:30 AM{/i}"
    mc "It's time to go!"
    "I walk to the front of the house and put on my shoes and put my hand on the door handle."
    mc "Wait..."
    "I'm just thinking about it now."
    "I head back to the fridge to get a sandwhich that I made yesterday."
    "The weather is great outside, I could eat on the roof of the school at the lunch break."
    "Once the sandwich in my bag, I redirect myself outside, locking the door."
    play sound closet_close
    show bg residential_day
    with wiperight_scene
    play music morning
    "Annnnnnnnnnnnnnd... I start doing the same itinerary every morning on my way to school."
    show bg re2
    with wiperight
    "On the way, I couldn't imagine how the day is going to go."
    "Especially at the club with the girls."
    "I was imagining every scenario."
    "Whether it's the worst that could happen like they didn't do their poem because they forgot or whatever reason and I'm left like a jerk with the only one who did."
    "Or... everything is going to be fine and that I am a little to..."
    "... I don't know how I could describe myself right now."
    "I'm excited to see how they express themselves."
    "But at the same time, I'm dreading this moment."
    "Well..."
    "I think I'm just overthinking."
    "It will come in due time."
    "..."
    "For the moment..."
    "All I have to do is make a good impression to the girls."
    "I even said it yesterday at the meeting... my goal is to make everyone get along and feel good in the club."
    "Focus on that, [player]... just focus on that."
